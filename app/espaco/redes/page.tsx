...
import { getRedesPorAno } from "@/data/espaco/articulacao-rede";

function RedesPage() {
  const redesPorAno = getRedesPorAno();
  const anos = Object.keys(redesPorAno)
    .map(Number)
    .sort((a, b) => b - a);
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-sm text-gray-300 mb-8">
                ...
                <span>/</span>
                <span className="text-clr4">Articulação em Redes</span>
              </div>
          ...
          >
            <div className="max-w-7xl mx-auto px-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {redesPorAno[ano].map((evento, index) => (
                  <motion.div
                    key={evento.slug}
