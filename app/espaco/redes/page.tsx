          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-sm text-gray-300 mb-8">
                ...
                <span>/</span>
                <span className="text-clr4">Articulação em Rede</span>
              </div>

              {/* Título */}
              <h1 className="text-6xl md:text-7xl font-black mb-6 leading-none">
                Articulação em <span className="text-clr4">Rede</span>
              </h1>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                  O que é <span className="text-clr4">Articulação em Rede</span>
                  ?
                </h2>
          ...
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-6">
                Faça parte da nossa <span className="text-clr4">rede</span>
              </h2>
