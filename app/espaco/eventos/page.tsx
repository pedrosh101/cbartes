...
import { getEventosPorAno } from "@/data/espaco/eventos";

function EventosPage() {
  const eventosPorAno = getEventosPorAno();
  const anos = Object.keys(eventosPorAno)
    .map(Number)
    .sort((a, b) => b - a);
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-sm text-gray-300 mb-8">
                ...
                <span>/</span>
                <span className="text-clr4">Eventos</span>
              </div>
              ...
              <p className="text-xl text-gray-200 max-w-3xl leading-relaxed">
                Confira os eventos e atividades realizadas pelo Espaço Cultural
                CBARTES
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="max-w-7xl mx-auto px-8">
              ...
              >
                <div className="flex items-baseline gap-6 mb-4">
                  ...
                  <div className="text-base uppercase tracking-wider text-gray-500">
                    {eventosPorAno[ano].length}{" "}
                    {eventosPorAno[ano].length === 1 ? "evento" : "eventos"}
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {eventosPorAno[ano].map((evento, index) => (
                  <motion.div
                    key={evento.slug}
                  ...
                  >
                    <Link href={`/espaco/eventos/${evento.slug}`}>
                      <div className="group cursor-pointer h-full">
                        ...
                        {/* Info */}
                        <div>
                          <h3 className="text-xl font-bold text-white mb-2 group-hover:text-clr4 transition-colors line-clamp-2">
                            {evento.titulo}
                          </h3>
          ...
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-6">
                Participe dos nossos <span className="text-clr4">eventos</span>
              </h2>
