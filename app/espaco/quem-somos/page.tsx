...
function QuemSomos() {
  ...
  return (
    <>
      <CustomCursor />
      <NavbarInside color="#3e6af3" colorText="black" isBlack />
      ...
      <main className="font-futura bg-black text-white overflow-hidden cursor-none">
        ...
        <section className="pt-32 pb-20 bg-zinc-900 relative overflow-hidden">
          <div className="absolute inset-0 opacity-5">
            <div className="absolute inset-0 bg-linear-to-br from-clr4/20 to-transparent" />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
                ...
                <span>/</span>
                <span className="text-clr4">Quem Somos</span>
              </div>
              ...
              <div className="mb-12">
                ...
                >
                  Quem <span className="text-clr4">Somos</span>
                </motion.h1>
                <motion.div
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                  transition={{ duration: 0.8, delay: 0.4 }}
                  className="w-32 h-1 bg-clr4 origin-left"
                />
              </div>
              ...
              >
                Uma Espaço cultural comprometida com a democratização do acesso às artes
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                  Nossa <span className="text-clr4">História</span>
                </h2>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <Image
                  ...
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
                <div className="absolute inset-0 bg-clr4/10" />
              </motion.div>
              ...
              >
                <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                  Nossa <span className="text-clr4">Missão</span>
                </h2>
                <div className="w-24 h-1 bg-clr4 mb-8" />
                <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                  <p>
        ...
        <section className="py-32 bg-black relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10">
            ...
            >
              <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                Nossos <span className="text-clr4">Valores</span>
              </h2>
              <div className="w-24 h-1 bg-clr4 mb-8" />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="group"
                  >
                    <div className="border-l-4 border-clr4 pl-6 py-2 hover:border-[#d4b93c] transition-colors">
                      <h3 className="text-2xl font-bold mb-2 text-clr4">{valor.titulo}</h3>
          ...
          <div className="max-w-7xl mx-auto px-8">
            ...
            >
              <h2 className="text-5xl md:text-6xl font-black mb-6">
                Como <span className="text-clr4">Atuamos</span>
              </h2>
              <div className="w-32 h-1 bg-clr4 mx-auto mb-8" />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  className="group relative bg-black border border-zinc-800 hover:border-clr4 rounded-sm p-8 transition-all duration-500"
                >
        ...
        <section className="py-32 bg-black">
          <div className="max-w-4xl mx-auto px-8">
            ...
            >
              <h2 className="text-5xl md:text-6xl font-black mb-6">
                Nossa <span className="text-clr4">Trajetória</span>
              </h2>
            ...
            <div className="relative">
              ...
              <div className="space-y-12">
                {[
                  ...
                  >
                    <div className="absolute left-0 w-16 h-16 rounded-full bg-clr4 flex items-center justify-center border-4 border-black">
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-sm p-6">
                      <h3 className="text-2xl font-black mb-2 text-clr4">{marco.titulo}</h3>
          ...
          <div className="max-w-5xl mx-auto px-8 relative z-10 text-center">
            ...
            >
              <h2 className="text-5xl md:text-7xl font-black mb-8 leading-tight">
                Nosso <span className="text-clr4">Compromisso</span>
              </h2>
          ...
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-6">
                Faça parte dessa <span className="text-clr4">história</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/espaco">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-10 py-4 bg-clr4 text-black text-base font-bold uppercase tracking-widest rounded-full hover:bg-[#d4b93c] transition-colors duration-300"
                  >
                    Voltar para Espaço
                  </motion.button>
                </Link>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-10 py-4 bg-transparent border-2 border-clr4 text-clr4 text-base font-bold uppercase tracking-widest rounded-full hover:bg-clr4 hover:text-black transition-all duration-300"
                >
                  Fale Conosco
                </motion.button>
              </div>
