...
function QuemSomos() {
  ...
  return (
    <>
      <CustomCursor />
      <NavbarInside color="#f1443e" colorText="black" isBlack />
      ...
      <main className="font-futura bg-black text-white overflow-hidden cursor-none">
        ...
        <section className="pt-32 pb-20 bg-zinc-900 relative overflow-hidden">
          <div className="absolute inset-0 opacity-5">
            <div className="absolute inset-0 bg-linear-to-br from-clr1/20 to-transparent" />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
                <Link href="/companhia" className="hover:text-clr1 transition-colors">
                  Companhia
                </Link>
                <span>/</span>
                <span className="text-clr1">Quem Somos</span>
              </div>
              ...
              <div className="mb-12">
                ...
                >
                  Quem <span className="text-clr1">Somos</span>
                </motion.h1>
                <motion.div
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                  transition={{ duration: 0.8, delay: 0.4 }}
                  className="w-32 h-1 bg-clr1 origin-left"
                />
              </div>
              ...
              >
                Uma Companhia cultural comprometida com a democratização do acesso às artes
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                  Nossa <span className="text-clr1">História</span>
                </h2>
                <div className="w-24 h-1 bg-clr1 mb-8" />
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <Image
                  ...
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
                <div className="absolute inset-0 bg-clr1/10" />
              </motion.div>
              ...
              >
                <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                  Nossa <span className="text-clr1">Missão</span>
                </h2>
                <div className="w-24 h-1 bg-clr1 mb-8" />
                <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                  <p>
        ...
        <section className="py-32 bg-black relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10">
            ...
            >
              <h2 className="text-5xl md:text-6xl font-black mb-8 leading-tight">
                Nossos <span className="text-clr1">Valores</span>
              </h2>
              <div className="w-24 h-1 bg-clr1 mb-8" />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="group"
                  >
                    <div className="border-l-4 border-clr1 pl-6 py-2 hover:border-[#d4b93c] transition-colors">
                      <h3 className="text-2xl font-bold mb-2 text-clr1">{valor.titulo}</h3>
          ...
          <div className="max-w-7xl mx-auto px-8">
            ...
            >
              <h2 className="text-5xl md:text-6xl font-black mb-6">
                Como <span className="text-clr1">Atuamos</span>
              </h2>
              <div className="w-32 h-1 bg-clr1 mx-auto mb-8" />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  className="group relative bg-black border border-zinc-800 hover:border-clr1 rounded-sm p-8 transition-all duration-500"
                >
                  <div className="text-7xl font-black text-clr1/20 mb-6 group-hover:text-clr1/30 transition-colors">
                    {item.numero}
                  </div>
                  <h3 className="text-3xl font-black mb-4 uppercase">{item.titulo}</h3>
                  <p className="text-gray-400 leading-relaxed">{item.desc}</p>
                  <div className="absolute bottom-0 left-0 w-0 h-1 bg-clr1 group-hover:w-full transition-all duration-500" />
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-32 bg-black">
          <div className="max-w-4xl mx-auto px-8">
            ...
            >
              ...
              <div className="w-32 h-1 bg-clr1 mx-auto" />
            </motion.div>

            <div className="relative">
              <div className="absolute left-8 top-0 bottom-0 w-px bg-clr1/30" />
              ...
              <div className="space-y-12">
                {[
                  ...
                  >
                    <div className="absolute left-0 w-16 h-16 rounded-full bg-clr1 flex items-center justify-center border-4 border-black">
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-sm p-6">
                      <h3 className="text-2xl font-black mb-2 text-clr1">{marco.titulo}</h3>
          ...
          <div className="max-w-5xl mx-auto px-8 relative z-10 text-center">
            ...
            >
              <h2 className="text-5xl md:text-7xl font-black mb-8 leading-tight">
                Nosso <span className="text-clr1">Compromisso</span>
              </h2>
              <div className="w-32 h-1 bg-clr1 mx-auto mb-12" />
          ...
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-6">
                Faça parte dessa <span className="text-clr1">história</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/companhia">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-10 py-4 bg-clr1 text-black text-base font-bold uppercase tracking-widest rounded-full hover:bg-[#d4b93c] transition-colors duration-300"
                  >
                    Voltar para Companhia
                  </motion.button>
                </Link>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-10 py-4 bg-transparent border-2 border-clr1 text-clr1 text-base font-bold uppercase tracking-widest rounded-full hover:bg-clr1 hover:text-black transition-all duration-300"
                >
                  Fale Conosco
                </motion.button>
              </div>
